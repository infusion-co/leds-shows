...
// ==== THUNDER MODE PARAMS
#define CENTRAL_NUAGE_END_0  150
#define RIGHT_NUAGE_END_0 150
#define RIGHT_THUNDER_1_END_0 150
#define RIGHT_THUNDER_2_END_0 150

#define CENTRAL_NUAGE_END_1 150
#define LEFT_NUAGE_END_1 150
#define LEFT_THUNDER_1_END_1 150
#define LEFT_THUNDER_2_END_1 150

#define THUNDER_START_1 150
#define THUNDER_START_2 150
...
void setModes() {
    ...
    uint8_t coptions = cc_options + REVERSE;
    strips[1].setSegment(0, 0, CENTRAL_NUAGE_END_1, cc_mode, cc_colors, cc_speed, coptions);
